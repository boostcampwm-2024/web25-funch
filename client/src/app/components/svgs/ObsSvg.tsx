...
const ObsSvg = ({ svgTitle, svgDescription }: SvgComponentProps) => {
  return (
    <svg fill="#000000" width="55px" height="55px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg">
      {svgTitle && <title>{svgTitle}</title>}
      {svgDescription && <desc>{svgDescription}</desc>}
      <title>OBS Studio icon</title>
