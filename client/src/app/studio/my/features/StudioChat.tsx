...
const ChatWrapper = ({ children }: Props) => {
  ...
  useEffect(() => {
    ...
    setChatname(loggedinUser.name);
    setBroadcastId(loggedinUser.broadcastId);
  }, [loggedinUser]);
  ...
  return (
    <aside className={clsx('h-full w-[20rem]', 'flex flex-col', 'border-border-neutral-weak border-x border-solid')}>
      <div
